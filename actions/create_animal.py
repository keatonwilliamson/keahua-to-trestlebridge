...
def create_animal_two_habitats(biome1, biome2, arb, animal):
 ...
 +-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-+\n''')
        ...
        # combine the two biome lists
        new_list = []
        for habitat1 in biome1:
            # add the habitat to the list if it is not full
 ...
 |  K  e  a  h  u  a    A  r  b  o  r  e  t  u  m  |
 +-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-+\n''')
            # loop over combined list and display in terminal
...
> ''')
            # if the user types M, take them to the main menu
            if choice1.lower() == "m":
                return
            try:
            # otherwise, add the animal to the habitat
                selection = new_list[int(choice1) - 1].id
                # search list1 (biome1) for the selection
                list1 = list(filter(lambda x: x.id == selection, biome1))
                # search list2 (biome2) for the selection
...
def create_animal_one_habitat(biome1, arb, animal):
 ...
 +-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-+\n''')
        ...
        for habitat in biome1:
            # if the biome is not full, add it to the list
