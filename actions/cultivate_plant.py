# CULTIVATE_PLANT.PY
#
# This module is responsible for generating and displaying the menu for
# cultivating a plant to the user. This module is called by the user from
# the main menu generated by index.py.
#
