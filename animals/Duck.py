...
class Duck(Animal, IFlying, IWalking, ITerrestrial, Identifiable):
 ...
 +-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-+\n''')
        if prey in self.__prey:
            print(f"The Duck ate {prey} for a meal")
            input("Press any button to continue...")
        else:
            print(f"The Duck rejects the {prey}")


    def __str__(self):
        return f"Duck {self.id}. Can we buy some more corn bro, please! I'm sick of eating grass!!!!"