...
import os
class Pig(Animal, IWalking, ITerrestrial, Identifiable):
 ...
 +-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-++-+\n''')
        if prey in self.__prey:
            print(f"The Pig ate {prey} for a meal\n")
            input("Press any button to continue...")
        else:
            print(f"The Pig rejects the {prey}")


    def __str__(self):
        return f"Pig {self.id}. I want more Grass dude!"